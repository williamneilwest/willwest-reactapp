...
export default function Navbar() {
    return (
    <div id='navbar' className='fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36'>
        <div className="flex justify-between items-center text-white">
            ...
            <li className="p-4"><a href="#accomplishments" className="hover:underline">Accomplishments</a></li>
            </ul>
