    ...
    return (
        <div  className="mt-4 text-white flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 mt-4 gap-5">
                <ProjectCard name="Data Engineering" img={sqlpython} issued="In this project, I generated data using the Fakr python library, populated this data into a locally-created/hosted Microsoft SQL Server, and am creating a dashboard visualization using Tableau." date="2023" url="https://github.com/williamneilwest/DataAnalysisProject"/>
